...
const ClientBookingForm: React.FC<{ initialUser?: UserData | null }> = ({ initialUser }) => {
  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 bg-white rounded shadow text-foreground">
